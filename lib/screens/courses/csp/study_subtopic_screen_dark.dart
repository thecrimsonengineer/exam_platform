...
import '../../../widgets/csp/study_content/study_content_navigation_dark.dart';
import '../../../widgets/csp/study_content/study_subtopic_renderer_dark.dart';
...
class DarkStudySubtopicScreen extends StatefulWidget {
  final StudyContent content;
  final int subtopicIndex;
  final String? domainTitle;

  const DarkStudySubtopicScreen({
    super.key,
  ...
  @override
  State<DarkStudySubtopicScreen> createState() =>
      _DarkStudySubtopicScreenState();
}

class _DarkStudySubtopicScreenState extends State<DarkStudySubtopicScreen> {
  ...
  @override
  void didUpdateWidget(covariant DarkStudySubtopicScreen oldWidget) {
        ...
        children: [
          ...
          Expanded(
            child: Text(
              ...
              style: DarkStudyTypography.cardTitle.copyWith(
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              title,
              style: DarkStudyTypography.heroTitle.copyWith(
                color: Colors.white,
