...
import 'lab/lab_batch2_release_screen.dart';
...
class _AdminHomeScreenState extends State<AdminHomeScreen>
  ...
  final List<_NavItem> navigation = const [
    ...
    _NavItem(Icons.rocket_launch_rounded, 'Batch 2 Release', 'CONTENT'),
  ...
  void _openBatch2Release() {
    final adminUserId = widget.adminUserId?.trim();
    if (adminUserId == null || adminUserId.isEmpty) {
      _showComingSoon('Batch 2 LAB release');
      return;
    }

    Navigator.of(context).push(
      MaterialPageRoute<void>(
        builder: (_) => LabBatch2ReleaseScreen(adminUserId: adminUserId),
      ),
    );
  }
