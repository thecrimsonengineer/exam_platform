...
class DarkStudyContentRenderer extends StatefulWidget {
  ...
  @override
  State<DarkStudyContentRenderer> createState() =>
      _DarkStudyContentRendererState();
}

class _DarkStudyContentRendererState extends State<DarkStudyContentRenderer> {
  ...
  @override
  void didUpdateWidget(covariant DarkStudyContentRenderer oldWidget) {
        ...
        Expanded(
          child: Column(
            ...
            children: [
              ...
              Text(
                'Choose a topic',
                style: DarkStudyTypography.sectionTitle.copyWith(
                  color: DarkStudyColors.textPrimary,
                ),
              ),
            ],
    ...
    switch (state) {
      ...
      case StudentLearningState.inProgress:
        return _buildStatusChip(
          ...
          foreground: DarkStudyColors.primary,
          background: DarkStudyColors.primaryLight,
          border: DarkStudyColors.primary.withValues(alpha: 0.16),
        );
      case StudentLearningState.notStarted:
        return _buildStatusChip(
          label: 'Not Started',
          icon: Icons.radio_button_unchecked_rounded,
          foreground: DarkStudyColors.textSecondary,
          background: DarkStudyColors.surfaceSoft,
          border: DarkStudyColors.border,
        );
    }
  }
