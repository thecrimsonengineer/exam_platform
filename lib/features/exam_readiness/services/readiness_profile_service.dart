...
class ReadinessProfileService {
  ...
  List<ReadinessGap> _gaps({
    ...
    final evidenceConfidence = evidence.evidenceQuality.confidenceLevel;

    if (evidenceConfidence.rank <= EvidenceConfidence.low.rank) {
      gaps.add(
        ReadinessGap(
          type: ReadinessGapType.evidenceGap,
          severity: evidenceConfidence == EvidenceConfidence.none ||
