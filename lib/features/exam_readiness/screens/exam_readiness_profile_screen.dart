...
class ExamReadinessProfileScreen extends StatefulWidget {
  ...
  @override
  State<ExamReadinessProfileScreen> createState() =>
      _ExamReadinessProfileScreenState();
}

class _ExamReadinessProfileScreenState
    extends State<ExamReadinessProfileScreen> {
              ...
              child: ListView(
                ...
                children: [
                  ...
                  _CompetencyMatrix(
                    dashboard: dashboard,
                    onTap: (profile) =>
                        _showCompetencyExplanation(context, profile),
                  ),
                  const SizedBox(height: 18),
                  Text(
  ...
  Future<void> _showCompetencyExplanation(
    ...
    await showModalBottomSheet<void>(
      ...
      builder: (context) => SafeArea(
        child: SingleChildScrollView(
          ...
          child: _CompetencyExplanation(profile: profile),
        ),
      ),
    );
  }
...
class _CompetencyExplanation extends StatelessWidget {
  const _CompetencyExplanation({required this.profile});
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      key: const ValueKey('m7c-competency-explanation'),
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Text(
          profile.competencyId.toUpperCase(),
