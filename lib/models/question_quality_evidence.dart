class DqgEvidenceRecord {
  ...
  bool get isComplete =>
      ruleId.trim().isNotEmpty &&
      proof.trim().isNotEmpty &&
      evidenceRefs.isNotEmpty &&
      evidenceRefs.every((value) => value.trim().isNotEmpty) &&
      reviewerId.trim().isNotEmpty &&
      reviewedAtIso.trim().isNotEmpty;

  DqgEvidenceRecord copyWith({
    String? ruleId,
    bool? satisfied,
    String? proof,
  ...
  DistractorQualityEvidence copyWith({
    ...
    return DistractorQualityEvidence(
      ...
      misconceptionFingerprint:
          misconceptionFingerprint ?? this.misconceptionFingerprint,
      targetedMisconception:
          targetedMisconception ?? this.targetedMisconception,
      ...
      scenarioAnchorsValid:
          scenarioAnchorsValid ?? this.scenarioAnchorsValid,
      ...
      counterfactualToBecomeCorrect:
          counterfactualToBecomeCorrect ?? this.counterfactualToBecomeCorrect,
      sameTechnicalUniverse:
          sameTechnicalUniverse ?? this.sameTechnicalUniverse,
      sameProfessionalLevel:
          sameProfessionalLevel ?? this.sameProfessionalLevel,
      substantiallyTechnicallyCorrect:
          substantiallyTechnicallyCorrect ?? this.substantiallyTechnicallyCorrect,
      professionalTerminologyValid:
          professionalTerminologyValid ?? this.professionalTerminologyValid,
      addressesActualDecisionOrHazard:
          addressesActualDecisionOrHazard ?? this.addressesActualDecisionOrHazard,
      credibleInProfessionalPractice:
          credibleInProfessionalPractice ?? this.credibleInProfessionalPractice,
      singleFatalFlaw: singleFatalFlaw ?? this.singleFatalFlaw,
      multipleUnrelatedDefectsDetected:
          multipleUnrelatedDefectsDetected ??
          this.multipleUnrelatedDefectsDetected,
      sophisticatedReasoningPath:
          sophisticatedReasoningPath ?? this.sophisticatedReasoningPath,
      counterfactualMinimalAndPlausible:
          counterfactualMinimalAndPlausible ??
          this.counterfactualMinimalAndPlausible,
      grammarParallel: grammarParallel ?? this.grammarParallel,
      specificityAndDetailParallel:
          specificityAndDetailParallel ?? this.specificityAndDetailParallel,
      lengthAndClauseParallel:
          lengthAndClauseParallel ?? this.lengthAndClauseParallel,
      terminologyUnitsPrecisionParallel:
          terminologyUnitsPrecisionParallel ??
          this.terminologyUnitsPrecisionParallel,
      conditionalWordingParallel:
          conditionalWordingParallel ?? this.conditionalWordingParallel,
      linguisticCueDetected:
          linguisticCueDetected ?? this.linguisticCueDetected,
      keywordLeakageDetected:
          keywordLeakageDetected ?? this.keywordLeakageDetected,
      absoluteLanguageShortcutDetected:
          absoluteLanguageShortcutDetected ??
          this.absoluteLanguageShortcutDetected,
      nonTechnicalEliminationShortcutDetected:
          nonTechnicalEliminationShortcutDetected ??
          this.nonTechnicalEliminationShortcutDetected,
      sourceSupportsRejectionDistinction:
          sourceSupportsRejectionDistinction ??
          this.sourceSupportsRejectionDistinction,
      smeRejectionProof: smeRejectionProof ?? this.smeRejectionProof,
      distractorCalculationPath:
          distractorCalculationPath ?? this.distractorCalculationPath,
      calculationConsistent:
          calculationConsistent ?? this.calculationConsistent,
    );
  }
}
...
class QuestionQualityEvidence {
  ...
  final Map<String, DqgEvidenceRecord> ruleEvidence;
  ...
  QuestionQualityEvidence copyWith({
    ...
    return QuestionQualityEvidence(
      ...
      distractorFailedCriteria:
          distractorFailedCriteria ?? this.distractorFailedCriteria,
      criterionMatrixComplete:
          criterionMatrixComplete ?? this.criterionMatrixComplete,
      ...
      defensibleBestAnswerCount:
          defensibleBestAnswerCount ?? this.defensibleBestAnswerCount,
      reviewComplete: reviewComplete ?? this.reviewComplete,
      manualOverrideRequested:
          manualOverrideRequested ?? this.manualOverrideRequested,
      unresolvedBlockCount:
          unresolvedBlockCount ?? this.unresolvedBlockCount,
      unresolvedFailCount: unresolvedFailCount ?? this.unresolvedFailCount,
      unresolvedWarningCount:
          unresolvedWarningCount ?? this.unresolvedWarningCount,
      keyRequiresNoUnstatedAssumption:
          keyRequiresNoUnstatedAssumption ??
          this.keyRequiresNoUnstatedAssumption,
      assumptionsDocumented:
          assumptionsDocumented ?? this.assumptionsDocumented,
      keyAssumptionsSupported:
          keyAssumptionsSupported ?? this.keyAssumptionsSupported,
      noEquivalenceFromUnstatedAssumption:
          noEquivalenceFromUnstatedAssumption ??
          this.noEquivalenceFromUnstatedAssumption,
      assumptions: assumptions ?? this.assumptions,
      authoritativeSources: authoritativeSources ?? this.authoritativeSources,
      sourceAuthorityVerified:
          sourceAuthorityVerified ?? this.sourceAuthorityVerified,
      sourceSupportsKey: sourceSupportsKey ?? this.sourceSupportsKey,
      noUnsupportedMicroscopicDistinction:
          noUnsupportedMicroscopicDistinction ??
          this.noUnsupportedMicroscopicDistinction,
      ambiguityDetected: ambiguityDetected ?? this.ambiguityDetected,
      semanticDuplicateOptionsDetected:
          semanticDuplicateOptionsDetected ??
          this.semanticDuplicateOptionsDetected,
      answerPositionCueDetected:
          answerPositionCueDetected ?? this.answerPositionCueDetected,
      answerKeyVerified: answerKeyVerified ?? this.answerKeyVerified,
      stemSufficient: stemSufficient ?? this.stemSufficient,
      testsIntendedCompetency:
          testsIntendedCompetency ?? this.testsIntendedCompetency,
      numericQuestion: numericQuestion ?? this.numericQuestion,
      wrongLevelCorrectnessApplicable:
          wrongLevelCorrectnessApplicable ??
          this.wrongLevelCorrectnessApplicable,
      wrongLevelDistinctionDocumented:
          wrongLevelDistinctionDocumented ??
          this.wrongLevelDistinctionDocumented,
      sophisticationParityApplicable:
          sophisticationParityApplicable ?? this.sophisticationParityApplicable,
      sophisticationParitySatisfied:
          sophisticationParitySatisfied ?? this.sophisticationParitySatisfied,
      advancedDistractorPresentWhenApplicable:
          advancedDistractorPresentWhenApplicable ??
          this.advancedDistractorPresentWhenApplicable,
      optionSurfaceMetrics:
          optionSurfaceMetrics ?? this.optionSurfaceMetrics,
      noMaterialLengthCue: noMaterialLengthCue ?? this.noMaterialLengthCue,
      ruleEvidence: ruleEvidence ?? this.ruleEvidence,
    );
  }

  QuestionQualityEvidence withRuleEvidence(
    String ruleId,
    DqgEvidenceRecord record,
  ) {
    final next = Map<String, DqgEvidenceRecord>.from(ruleEvidence);
    next[ruleId] = record;
    return copyWith(ruleEvidence: next);
  }

  QuestionQualityEvidence withoutRuleEvidence(String ruleId) {
    final next = Map<String, DqgEvidenceRecord>.from(ruleEvidence);
    next.remove(ruleId);
    return copyWith(ruleEvidence: next);
  }
