...
void main() {
  group('StartupTimeline', () {
    test('maps exact Lottie marker boundaries to matching beats', () {
      ...
      expect(
        StartupTimeline.beatForProgress(18 / 144),
        StartupBeat.learn,
      );
      expect(
        StartupTimeline.beatForProgress(44 / 144),
        StartupBeat.practice,
      );
      expect(
        StartupTimeline.beatForProgress(70 / 144),
        StartupBeat.lab,
      );
      expect(
        StartupTimeline.beatForProgress(96 / 144),
        StartupBeat.remember,
      );
      expect(
        StartupTimeline.beatForProgress(132 / 144),
        StartupBeat.converge,
      );
    });
    ...
    test('returns normalized progress inside each beat', () {
      ...
      expect(
        StartupTimeline.beatProgress(18 / 144, StartupBeat.ignite),
        1,
      );
      ...
      expect(
        StartupTimeline.beatProgress(1, StartupBeat.converge),
        1,
      );
    });
  });
