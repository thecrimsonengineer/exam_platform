...
void main() {
  const inventoryPath =
      'assets/flashcards/production/d01/d01_c03/'
      'd01_c03_concept_inventory.v1.json';
  const sourcePath =
