...
void main() {
  const inventoryPath =
      'assets/flashcards/production/d02/d02_c05/'
      'd02_c05_concept_inventory.v1.json';
  const sourcePath =
  ...
  test('D02 C05 defers existing generic process-safety concepts', () {
    final inventory = readObject(inventoryPath);
