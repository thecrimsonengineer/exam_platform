...
void main() {
  const inventoryPath =
      'assets/flashcards/production/d02/d02_c03/'
      'd02_c03_concept_inventory.v1.json';
  const sourcePath =
  ...
  test('D02 C03 defers generic performance and indicator concepts', () {
    final inventory = readObject(inventoryPath);
