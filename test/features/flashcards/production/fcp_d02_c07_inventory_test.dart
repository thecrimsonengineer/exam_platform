...
void main() {
  const inventoryPath =
      'assets/flashcards/production/d02/d02_c07/'
      'd02_c07_concept_inventory.v1.json';
  const sourcePath =
  ...
  test('D02 C07 candidates are unique and source-backed', () {
    ...
    expect(slugs, contains('leading_indicator'));
    expect(slugs, contains('lagging_indicator'));
  ...
  test('D02 C07 preserves prior canonical performance concepts', () {
    final inventory = readObject(inventoryPath);
