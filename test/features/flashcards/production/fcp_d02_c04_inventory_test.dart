...
void main() {
  const inventoryPath =
      'assets/flashcards/production/d02/d02_c04/'
      'd02_c04_concept_inventory.v1.json';
  const sourcePath =
  ...
  test('D02 C04 defers existing generic concepts', () {
    final inventory = readObject(inventoryPath);
