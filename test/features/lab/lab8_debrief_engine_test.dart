...
void main() {
  ...
  for (var i = 0; i < 10; i++) {
    test('LAB-8 chronological decision timeline ' + (i + 1).toString(), () async {
  ...
  for (var i = 0; i < 10; i++) {
    test('LAB-8 consequence gate and causal reconstruction ' + (i + 1).toString(), () async {
      ...
      expect(debrief.causalChain.last, contains('emergency_critical_failure'));
    });
  }

  for (var i = 0; i < 10; i++) {
    test('LAB-8 critical recovery and evidence reconstruction ' + (i + 1).toString(), () async {
  ...
  for (var i = 0; i < 10; i++) {
    test('LAB-8 authored alternate timeline determinism ' + (i + 1).toString(), () async {
  ...
  for (var i = 0; i < 10; i++) {
    test('LAB-8 incomplete session source backed behaviour ' + (i + 1).toString(), () async {
