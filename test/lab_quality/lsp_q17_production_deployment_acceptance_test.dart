...
void main() {
  test(
    'Q17 preflight binds frozen Q16, project, manifest and 10/50 corpus',
    () async {
  ...
  test(
    'Q17 guarded release operator refuses action before preflight',
    () async {
  ...
  test(
    'Q17 live acceptance reconstructs exact 10-LAB / 50-decision runtime',
    () async {
      final source = _FilePopulationSource();
  ...
  test(
    'Q17 static deployment contract pins Firebase target and immutable paths',
    () {
