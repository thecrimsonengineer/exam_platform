...
FCP-2I package validation passed at `581974ade60bbc4920bd3c8e86b475a08c0d4f18` in run `36005181011`. The closure metadata state must pass CI before `phase-fcp2i-d02-c09-closed` is created.
