...
Gate: `FCP2_D02_GREEN`  
Target checkpoint: `phase-fcp2-d02-closed`  
...
FCP-2N  d02_c14  CLOSED            18 cards
```
...
FCP-2H package validation: SHA `b1590fd7f5cb6d0a261c9af5b2d7fb93829a8cec`, run `36000014475`, SUCCESS, 12 cards, FCQ100 100/100, HOLD 0.
...
FCP-2N package validation: SHA `5a63cd47b9051bdc0ace0bcb6d03c3987c51dd8c`, run `36125872697`, SUCCESS, 18 cards, FCQ100 100/100, HOLD 0.

Domain 02 total: 14 competencies, 174 cards. FCP-2 is a CLOSED CANDIDATE pending validation of this closure metadata state.
